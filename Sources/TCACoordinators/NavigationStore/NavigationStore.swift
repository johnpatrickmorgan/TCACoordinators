...
/// NavigationStore manages a navigation flow of screens for use within a `NavigationView`.
...
extension NavigationStore where ScreenState: Identifiable {
...
extension NavigationStore where ID == Int {
