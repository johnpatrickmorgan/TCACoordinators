...
public extension IdentifiedArray where Element: RouteProtocol {
  /// Whether the IdentifiedArray of Routes is able to push new screens. If it is not possible to determine,
...
public extension IdentifiedArray where Element: RouteProtocol {
  ...
  /// Goes back to a given index in the identified array of routes.  The resulting count
  /// will be index + 1.
...
public extension IdentifiedArray where Element: RouteProtocol, Element.Screen: Equatable {
  /// Goes back to the topmost (most recently shown) screen in the stack
...
public extension IdentifiedArray where Element: RouteProtocol, Element.Screen: Identifiable {
...
public extension IdentifiedArray where Element: RouteProtocol, Element.Screen: Identifiable & Equatable {
  /// Goes back to the topmost (most recently shown) identifiable screen in the stack
  /// matching the given screen. If no screens are found, the routes array
  /// will be unchanged.
  /// - Parameter screen: The screen to goBack to.
