...
//        ),
//			routes: \.routes,//{ $0[keyPath: toLocalState] },
...
//    toLocalAction: CaseKeyPath<Self.Action, IdentifiedAction<Int, ScreenReducer.Action>>,
//    updateRoutes: CaseKeyPath<Self.Action, [Route<ScreenReducer.State>]>,
